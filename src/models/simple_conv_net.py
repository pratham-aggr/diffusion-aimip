...
class SimpleConvNet(BaseModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if hasattr(self, "spatial_shape_in") and self.spatial_shape_in is not None:
            b, s1, s2 = 1, self.spatial_shape_in[0], self.spatial_shape_in[1]
    ...
    def forward(self, inputs, time=None, condition=None, static_condition=None, return_time_emb: bool = False):
        """
        Args:
