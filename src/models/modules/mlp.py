...
from src.utilities.utils import to_2tuple


class Mlp(torch.nn.Module):
    """MLP as used in Vision Transformer, MLP-Mixer and related networksMLP module w/ dropout and configurable activation layer
