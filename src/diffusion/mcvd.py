...
class UNetMore_DDPM(BaseDiffusion):
    ...
    def p_losses(self, x, t: Tensor = None, condition: Tensor = None, cond_mask=None, **kwargs):
        # z, perturbed_x
        b = x.shape[0]
        ...
        z_pred = self.model(perturbed_x, time=t, condition=condition, cond_mask=cond_mask, **kwargs)
