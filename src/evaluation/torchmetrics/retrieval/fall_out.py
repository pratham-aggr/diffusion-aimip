...
from src.evaluation.torchmetrics.retrieval.base import RetrievalMetric, _retrieval_aggregate
...
class RetrievalFallOut(RetrievalMetric):
    ...
    Example:
        >>> from src.evaluation.torchmetrics.retrieval import RetrievalFallOut
