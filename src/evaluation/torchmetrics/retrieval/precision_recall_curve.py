...
from src.evaluation.torchmetrics.retrieval.base import _retrieval_aggregate
from src.evaluation.torchmetrics.utilities.checks import _check_retrieval_inputs
from src.evaluation.torchmetrics.utilities.data import _flexible_bincount, dim_zero_cat
...
class RetrievalPrecisionRecallCurve(Metric):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.retrieval import RetrievalPrecisionRecallCurve
...
class RetrievalRecallAtFixedPrecision(RetrievalPrecisionRecallCurve):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.retrieval import RetrievalRecallAtFixedPrecision
        >>> indexes = tensor([0, 0, 0, 0, 1, 1, 1])
        >>> preds = tensor([0.4, 0.01, 0.5, 0.6, 0.2, 0.3, 0.5])
        >>> target = tensor([True, False, False, True, True, False, True])
