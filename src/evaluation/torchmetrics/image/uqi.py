...
from src.evaluation.torchmetrics.functional.image.uqi import _uqi_compute, _uqi_update
...
class UniversalImageQualityIndex(Metric):
    ...
    Example:
        >>> import torch
        >>> from src.evaluation.torchmetrics.image import UniversalImageQualityIndex
