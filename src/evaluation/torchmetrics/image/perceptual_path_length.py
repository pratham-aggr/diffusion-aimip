...
from src.evaluation.torchmetrics.functional.image.lpips import _LPIPS
from src.evaluation.torchmetrics.functional.image.perceptual_path_length import (
    GeneratorType,
        ...
        **kwargs: Any,
        ...
        if not _TORCHVISION_AVAILABLE:
            raise ModuleNotFoundError(
                ...
                "Install with `pip install torchvision` or `pip install src.evaluation.torchmetrics[image]`"
            )
        _perceptual_path_length_validate_arguments(
