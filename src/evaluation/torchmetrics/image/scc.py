...
from src.evaluation.torchmetrics.functional.image.scc import _scc_per_channel_compute as _scc_compute
from src.evaluation.torchmetrics.functional.image.scc import _scc_update
...
class SpatialCorrelationCoefficient(Metric):
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.image import SpatialCorrelationCoefficient as SCC
