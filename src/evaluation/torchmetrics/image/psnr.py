...
from src.evaluation.torchmetrics.functional.image.psnr import _psnr_compute, _psnr_update
...
class PeakSignalNoiseRatio(Metric):
    ...
    Example:
        >>> from src.evaluation.torchmetrics.image import PeakSignalNoiseRatio
