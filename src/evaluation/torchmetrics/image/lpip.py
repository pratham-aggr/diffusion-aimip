...
from src.evaluation.torchmetrics.functional.image.lpips import _LPIPS, _lpips_compute, _lpips_update, _NoTrainLpips
...
class LearnedPerceptualImagePatchSimilarity(Metric):
    ...
    .. hint::
        ...
        ``pip install src.evaluation.torchmetrics[image]`` or ``pip install torchvision``.
        ...
        **kwargs: Any,
        ...
        if not _TORCHVISION_AVAILABLE:
            raise ModuleNotFoundError(
                ...
                " Either install as `pip install src.evaluation.torchmetrics[image]` or `pip install torchvision`."
            )
