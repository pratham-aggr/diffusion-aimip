...
from src.evaluation.torchmetrics.functional.image.sam import _sam_compute, _sam_update
...
class SpectralAngleMapper(Metric):
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.image import SpectralAngleMapper
