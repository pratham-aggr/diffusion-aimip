...
from src.evaluation.torchmetrics.functional.image.ssim import _multiscale_ssim_update, _ssim_check_inputs, _ssim_update
...
class StructuralSimilarityIndexMeasure(Metric):
    ...
    Example:
        >>> import torch
        >>> from src.evaluation.torchmetrics.image import StructuralSimilarityIndexMeasure
...
class MultiScaleStructuralSimilarityIndexMeasure(Metric):
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.image import MultiScaleStructuralSimilarityIndexMeasure
        >>> preds = torch.rand([3, 3, 256, 256])
        >>> target = preds * 0.75
