...
from src.evaluation.torchmetrics.functional.image.psnrb import _psnrb_compute, _psnrb_update
...
class PeakSignalNoiseRatioWithBlockedEffect(Metric):
    ...
    def plot(
        ...
        .. plot::
            ...
            >>> import torch
            >>> from src.evaluation.torchmetrics.image import PeakSignalNoiseRatioWithBlockedEffect
            >>> metric = PeakSignalNoiseRatioWithBlockedEffect()
