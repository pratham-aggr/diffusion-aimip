...
from src.evaluation.torchmetrics.functional.image.d_s import (
...
class SpatialDistortionIndex(Metric):
    ...
    :class:`~src.evaluation.torchmetrics.image.UniversalImageQualityIndex` for more info), :math:`\\hat{G_l}` is the l-th band of the
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.image import SpatialDistortionIndex
