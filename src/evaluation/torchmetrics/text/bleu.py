...
from src.evaluation.torchmetrics.functional.text.bleu import _bleu_score_compute, _bleu_score_update, _tokenize_fn
...
class BLEUScore(Metric):
    ...
    Example:
        >>> from src.evaluation.torchmetrics.text import BLEUScore
