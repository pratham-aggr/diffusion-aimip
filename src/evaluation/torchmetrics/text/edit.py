...
from src.evaluation.torchmetrics.functional.text.edit import _edit_distance_compute, _edit_distance_update
...
class EditDistance(Metric):
    ...
    Example::
        ...
        >>> from src.evaluation.torchmetrics.text import EditDistance
        >>> metric = EditDistance()
        >>> metric(["rain"], ["shine"])
        tensor(3.)
