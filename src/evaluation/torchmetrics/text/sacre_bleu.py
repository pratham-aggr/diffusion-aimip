...
from src.evaluation.torchmetrics.functional.text.bleu import _bleu_score_update
from src.evaluation.torchmetrics.functional.text.sacre_bleu import _SacreBLEUTokenizer, _TokenizersLiteral
...
class SacreBLEUScore(BLEUScore):
    ...
    Example:
        >>> from src.evaluation.torchmetrics.text import SacreBLEUScore
