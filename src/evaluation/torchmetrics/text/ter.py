...
from src.evaluation.torchmetrics.functional.text.ter import _ter_compute, _ter_update, _TercomTokenizer
...
class TranslationEditRate(Metric):
    ...
    Example:
        >>> from src.evaluation.torchmetrics.text import TranslationEditRate
