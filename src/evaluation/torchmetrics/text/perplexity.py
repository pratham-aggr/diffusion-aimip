...
from src.evaluation.torchmetrics.functional.text.perplexity import _perplexity_compute, _perplexity_update
...
class Perplexity(Metric):
    ...
    Examples:
        ...
        >>> from src.evaluation.torchmetrics.text import Perplexity
        >>> preds = rand(2, 8, 5)
