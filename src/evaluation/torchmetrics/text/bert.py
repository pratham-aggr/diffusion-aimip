...
from src.evaluation.torchmetrics.functional.text.helper_embedding_metric import _preprocess_text
from src.evaluation.torchmetrics.metric import Metric
from src.evaluation.torchmetrics.utilities import rank_zero_warn
from src.evaluation.torchmetrics.utilities.checks import _SKIP_SLOW_DOCTEST, _try_proceed_with_timeout
from src.evaluation.torchmetrics.utilities.data import dim_zero_cat
from src.evaluation.torchmetrics.utilities.imports import _MATPLOTLIB_AVAILABLE, _TRANSFORMERS_GREATER_EQUAL_4_4
        ...
        if user_tokenizer:
            ...
            if not _TRANSFORMERS_GREATER_EQUAL_4_4:
                raise ModuleNotFoundError(
                    ...
                    " Either install with `pip install transformers>=4.4` or `pip install src.evaluation.torchmetrics[text]`."
                )
