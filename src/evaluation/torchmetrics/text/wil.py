...
from src.evaluation.torchmetrics.functional.text.wil import _word_info_lost_compute, _word_info_lost_update
...
class WordInfoLost(Metric):
    ...
    Examples:
        >>> from src.evaluation.torchmetrics.text import WordInfoLost
