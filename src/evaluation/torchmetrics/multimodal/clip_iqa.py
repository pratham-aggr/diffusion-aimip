...
from src.evaluation.torchmetrics.functional.multimodal.clip_iqa import (
    _clip_iqa_compute,
...
class CLIPImageQualityAssessment(Metric):
    ...
    .. hint::
        ...
        `pip install piq` or `pip install src.evaluation.torchmetrics[image]`.
    ...
    Example::
        ...
        >>> from src.evaluation.torchmetrics.multimodal import CLIPImageQualityAssessment
    ...
    def plot(self, val: Union[Tensor, Sequence[Tensor], None] = None, ax: Optional[_AX_TYPE] = None) -> _PLOT_OUT_TYPE:
        ...
        .. plot::
            ...
            >>> import torch
            >>> from src.evaluation.torchmetrics.multimodal.clip_iqa import CLIPImageQualityAssessment
            >>> metric = CLIPImageQualityAssessment()
