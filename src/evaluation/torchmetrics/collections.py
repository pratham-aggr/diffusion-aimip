...
from src.evaluation.torchmetrics.utilities.data import _flatten, _flatten_dict, allclose
...
class MetricCollection(ModuleDict):
    ...
    Example::
        ...
        >>> from src.evaluation.torchmetrics.regression import MeanSquaredError
        >>> from src.evaluation.torchmetrics.classification import MulticlassAccuracy, MulticlassPrecision, MulticlassRecall
            ...
            for name in sorted(metrics.keys()):
                ...
                if not isinstance(metric, (Metric, MetricCollection)):
                    raise ValueError(
                        ...
                        " `src.evaluation.torchmetrics.Metric` or `src.evaluation.torchmetrics.MetricCollection`"
                    )
    ...
    def plot(
        ...
        .. plot::
            ...
            >>> import torch
            >>> from src.evaluation.torchmetrics import MetricCollection
            >>> from src.evaluation.torchmetrics.classification import BinaryAccuracy, BinaryPrecision, BinaryRecall
