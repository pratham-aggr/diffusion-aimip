...
from src.evaluation.torchmetrics.functional.regression.kl_divergence import _kld_compute, _kld_update
...
class KLDivergence(Metric):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.regression import KLDivergence
