...
from src.evaluation.torchmetrics.functional.regression.nrmse import (
...
class NormalizedRootMeanSquaredError(Metric):
    ...
    Example::
        ...
        >>> import torch
        >>> from src.evaluation.torchmetrics import NormalizedRootMeanSquaredError
    ...
    def plot(
        ...
        .. plot::
            ...
            >>> from src.evaluation.torchmetrics.regression import NormalizedRootMeanSquaredError
