...
from src.evaluation.torchmetrics.functional.regression.r2 import _r2_score_update
from src.evaluation.torchmetrics.functional.regression.rse import _relative_squared_error_compute
...
class RelativeSquaredError(Metric):
    ...
    Example:
        >>> from src.evaluation.torchmetrics.regression import RelativeSquaredError
