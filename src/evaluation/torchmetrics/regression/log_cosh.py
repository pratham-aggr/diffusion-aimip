...
from src.evaluation.torchmetrics.functional.regression.log_cosh import _log_cosh_error_compute, _log_cosh_error_update
...
class LogCoshError(Metric):
    ...
    Example (single output regression)::
        >>> from src.evaluation.torchmetrics.regression import LogCoshError
