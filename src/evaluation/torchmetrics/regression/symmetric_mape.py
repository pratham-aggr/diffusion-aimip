...
from src.evaluation.torchmetrics.functional.regression.symmetric_mape import (
...
class SymmetricMeanAbsolutePercentageError(Metric):
    ...
    Example:
        >>> from src.evaluation.torchmetrics.regression import SymmetricMeanAbsolutePercentageError
