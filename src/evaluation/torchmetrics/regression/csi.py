...
from src.evaluation.torchmetrics.functional.regression.csi import (
    _critical_success_index_compute,
    _critical_success_index_update,
)
from src.evaluation.torchmetrics.metric import Metric
from src.evaluation.torchmetrics.utilities import dim_zero_cat
...
class CriticalSuccessIndex(Metric):
    ...
    Example:
        >>> import torch
        >>> from src.evaluation.torchmetrics.regression import CriticalSuccessIndex
