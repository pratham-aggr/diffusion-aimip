...
from src.evaluation.torchmetrics.functional.regression.concordance import _concordance_corrcoef_compute
from src.evaluation.torchmetrics.regression.pearson import PearsonCorrCoef, _final_aggregation
...
class ConcordanceCorrCoef(PearsonCorrCoef):
    ...
    Example (single output regression):
        >>> from src.evaluation.torchmetrics.regression import ConcordanceCorrCoef
        >>> from torch import tensor
