...
class BinaryHingeLoss(Metric):
    ...
    Example:
        >>> from src.evaluation.torchmetrics.classification import BinaryHingeLoss
...
class MulticlassHingeLoss(Metric):
    ...
    Example:
        >>> from src.evaluation.torchmetrics.classification import MulticlassHingeLoss
...
class HingeLoss(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinaryHingeLoss` and :class:`~src.evaluation.torchmetrics.classification.MulticlassHingeLoss`
