...
class BinaryJaccardIndex(BinaryConfusionMatrix):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import BinaryJaccardIndex
...
class MulticlassJaccardIndex(MulticlassConfusionMatrix):
    ...
    Example (pred is integer tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassJaccardIndex
...
class MultilabelJaccardIndex(MultilabelConfusionMatrix):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MultilabelJaccardIndex
...
class JaccardIndex(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinaryJaccardIndex`,
    :class:`~src.evaluation.torchmetrics.classification.MulticlassJaccardIndex` and
    :class:`~src.evaluation.torchmetrics.classification.MultilabelJaccardIndex` for the specific details of each argument influence
    and examples.
