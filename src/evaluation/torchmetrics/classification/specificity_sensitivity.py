...
class BinarySpecificityAtSensitivity(BinaryPrecisionRecallCurve):
    ...
    Example:
        >>> from src.evaluation.torchmetrics.classification import BinarySpecificityAtSensitivity
        >>> from torch import tensor
...
class MulticlassSpecificityAtSensitivity(MulticlassPrecisionRecallCurve):
    ...
    Example:
        >>> from src.evaluation.torchmetrics.classification import MulticlassSpecificityAtSensitivity
        >>> from torch import tensor
...
class MultilabelSpecificityAtSensitivity(MultilabelPrecisionRecallCurve):
    ...
    Example:
        >>> from src.evaluation.torchmetrics.classification import MultilabelSpecificityAtSensitivity
        >>> from torch import tensor
...
class SpecificityAtSensitivity(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinarySpecificityAtSensitivity`,
    :class:`~src.evaluation.torchmetrics.classification.MulticlassSpecificityAtSensitivity` and
    :class:`~src.evaluation.torchmetrics.classification.MultilabelSpecificityAtSensitivity` for the specific details of each argument
