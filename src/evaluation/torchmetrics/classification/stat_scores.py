...
class BinaryStatScores(_AbstractStatScores):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import BinaryStatScores
...
class MulticlassStatScores(_AbstractStatScores):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassStatScores
...
class MultilabelStatScores(_AbstractStatScores):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MultilabelStatScores
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
class StatScores(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinaryStatScores`, :class:`~src.evaluation.torchmetrics.classification.MulticlassStatScores`
    and :class:`~src.evaluation.torchmetrics.classification.MultilabelStatScores` for the specific details of each argument influence
    and examples.
