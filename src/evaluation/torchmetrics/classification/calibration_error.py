...
from src.evaluation.torchmetrics.utilities.enums import ClassificationTaskNoMultilabel
...
class BinaryCalibrationError(Metric):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import BinaryCalibrationError
...
class MulticlassCalibrationError(Metric):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassCalibrationError
...
class CalibrationError(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinaryCalibrationError` and
    :class:`~src.evaluation.torchmetrics.classification.MulticlassCalibrationError` for the specific details of each argument influence
    and examples.
