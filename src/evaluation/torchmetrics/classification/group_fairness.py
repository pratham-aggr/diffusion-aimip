...
from src.evaluation.torchmetrics.functional.classification.stat_scores import _binary_stat_scores_arg_validation
...
class BinaryGroupStatRates(_AbstractGroupStatScores):
    ...
    Example (preds is int tensor):
        >>> from src.evaluation.torchmetrics.classification import BinaryGroupStatRates
...
class BinaryFairness(_AbstractGroupStatScores):
    ...
    Example (preds is int tensor):
        >>> from src.evaluation.torchmetrics.classification import BinaryFairness
        >>> target = torch.tensor([0, 1, 0, 1, 0, 1])
        >>> preds = torch.tensor([0, 1, 0, 1, 0, 1])
        >>> groups = torch.tensor([0, 1, 0, 1, 0, 1])
