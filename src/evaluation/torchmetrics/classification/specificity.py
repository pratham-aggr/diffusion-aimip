...
from src.evaluation.torchmetrics.functional.classification.specificity import _specificity_reduce
...
class BinarySpecificity(BinaryStatScores):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import BinarySpecificity
...
class MulticlassSpecificity(MulticlassStatScores):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassSpecificity
...
class MultilabelSpecificity(MultilabelStatScores):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MultilabelSpecificity
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
class Specificity(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinarySpecificity`, :class:`~src.evaluation.torchmetrics.classification.MulticlassSpecificity`
    and :class:`~src.evaluation.torchmetrics.classification.MultilabelSpecificity` for the specific details of each argument influence
    and examples.
