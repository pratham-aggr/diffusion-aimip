...
from src.evaluation.torchmetrics.functional.classification.matthews_corrcoef import _matthews_corrcoef_reduce
...
class BinaryMatthewsCorrCoef(BinaryConfusionMatrix):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import BinaryMatthewsCorrCoef
...
class MulticlassMatthewsCorrCoef(MulticlassConfusionMatrix):
    ...
    Example (pred is integer tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassMatthewsCorrCoef
...
class MultilabelMatthewsCorrCoef(MultilabelConfusionMatrix):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MultilabelMatthewsCorrCoef
...
class MatthewsCorrCoef(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinaryMatthewsCorrCoef`,
    :class:`~src.evaluation.torchmetrics.classification.MulticlassMatthewsCorrCoef` and
    :class:`~src.evaluation.torchmetrics.classification.MultilabelMatthewsCorrCoef` for the specific details of each argument influence
    and examples.
