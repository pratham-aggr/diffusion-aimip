...
class BinaryCohenKappa(BinaryConfusionMatrix):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import BinaryCohenKappa
...
class MulticlassCohenKappa(MulticlassConfusionMatrix):
    ...
    Example (pred is integer tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassCohenKappa
...
class CohenKappa(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinaryCohenKappa` and
    :class:`~src.evaluation.torchmetrics.classification.MulticlassCohenKappa` for the specific details of each argument influence and
    examples.
