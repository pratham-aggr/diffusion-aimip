...
class BinaryRecallAtFixedPrecision(BinaryPrecisionRecallCurve):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import BinaryRecallAtFixedPrecision
...
class MulticlassRecallAtFixedPrecision(MulticlassPrecisionRecallCurve):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassRecallAtFixedPrecision
...
class MultilabelRecallAtFixedPrecision(MultilabelPrecisionRecallCurve):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MultilabelRecallAtFixedPrecision
...
class RecallAtFixedPrecision(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinaryRecallAtFixedPrecision`,
    :class:`~src.evaluation.torchmetrics.classification.MulticlassRecallAtFixedPrecision` and
    :class:`~src.evaluation.torchmetrics.classification.MultilabelRecallAtFixedPrecision` for the specific details of each argument
