...
from src.evaluation.torchmetrics.classification.roc import BinaryROC, MulticlassROC, MultilabelROC
...
class BinaryLogAUC(BinaryROC):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import BinaryLogAUC
...
class MulticlassLogAUC(MulticlassROC):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassLogAUC
        >>> preds = tensor([[0.75, 0.05, 0.05, 0.05, 0.05],
...
class MultilabelLogAUC(MultilabelROC):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MultilabelLogAUC
...
class LogAUC(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinaryLogAUC`, :class:`~src.evaluation.torchmetrics.classification.MulticlassLogAUC` and
    :class:`~src.evaluation.torchmetrics.classification.MultilabelLogAUC` for the specific details of each argument influence and
    examples.
