...
from src.evaluation.torchmetrics.functional.classification.dice import _dice_compute
from src.evaluation.torchmetrics.functional.classification.stat_scores import _stat_scores_update
from src.evaluation.torchmetrics.metric import Metric
from src.evaluation.torchmetrics.utilities import rank_zero_warn
from src.evaluation.torchmetrics.utilities.enums import AverageMethod, MDMCAverageMethod
...
class Dice(Metric):
    ...
    .. warning::
        The ``dice`` metrics is being deprecated from the classification subpackage in v1.6.0 of src.evaluation.torchmetrics and will
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import Dice
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        rank_zero_warn(
            "The `dice` metrics is being deprecated from the classification subpackage in v1.6.0 of src.evaluation.torchmetrics and"
