...
from src.evaluation.torchmetrics.utilities.enums import ClassificationTaskNoBinary
...
class MulticlassExactMatch(Metric):
    ...
    Example (multidim tensors):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassExactMatch
...
class MultilabelExactMatch(Metric):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MultilabelExactMatch
...
class ExactMatch(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.MulticlassExactMatch` and
    :class:`~src.evaluation.torchmetrics.classification.MultilabelExactMatch` for the specific details of each argument influence and
    examples.
