...
class BinaryAveragePrecision(BinaryPrecisionRecallCurve):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import BinaryAveragePrecision
...
class MulticlassAveragePrecision(MulticlassPrecisionRecallCurve):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassAveragePrecision
...
class MultilabelAveragePrecision(MultilabelPrecisionRecallCurve):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MultilabelAveragePrecision
...
class AveragePrecision(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinaryAveragePrecision`,
    :class:`~src.evaluation.torchmetrics.classification.MulticlassAveragePrecision` and
    :class:`~src.evaluation.torchmetrics.classification.MultilabelAveragePrecision` for the specific details of each argument
