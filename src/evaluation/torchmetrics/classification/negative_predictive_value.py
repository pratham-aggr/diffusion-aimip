...
class BinaryNegativePredictiveValue(BinaryStatScores):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import BinaryNegativePredictiveValue
...
class MulticlassNegativePredictiveValue(MulticlassStatScores):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassNegativePredictiveValue
...
class MultilabelNegativePredictiveValue(MultilabelStatScores):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MultilabelNegativePredictiveValue
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
class NegativePredictiveValue(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinaryNegativePredictiveValue`,
    :class:`~src.evaluation.torchmetrics.classification.MulticlassNegativePredictiveValue`
    and :class:`~src.evaluation.torchmetrics.classification.MultilabelNegativePredictiveValue` for the specific details of each
