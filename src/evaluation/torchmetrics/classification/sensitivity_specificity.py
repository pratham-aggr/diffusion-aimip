...
from src.evaluation.torchmetrics.utilities.data import dim_zero_cat as _cat
...
class BinarySensitivityAtSpecificity(BinaryPrecisionRecallCurve):
    ...
    Example:
        >>> from src.evaluation.torchmetrics.classification import BinarySensitivityAtSpecificity
        >>> from torch import tensor
...
class MulticlassSensitivityAtSpecificity(MulticlassPrecisionRecallCurve):
    ...
    Example:
        >>> from src.evaluation.torchmetrics.classification import MulticlassSensitivityAtSpecificity
        >>> from torch import tensor
...
class MultilabelSensitivityAtSpecificity(MultilabelPrecisionRecallCurve):
    ...
    Example:
        >>> from src.evaluation.torchmetrics.classification import MultilabelSensitivityAtSpecificity
        >>> from torch import tensor
...
class SensitivityAtSpecificity(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinarySensitivityAtSpecificity`,
    :class:`~src.evaluation.torchmetrics.classification.MulticlassSensitivityAtSpecificity` and
    :class:`~src.evaluation.torchmetrics.classification.MultilabelSensitivityAtSpecificity` for the specific details of each argument
