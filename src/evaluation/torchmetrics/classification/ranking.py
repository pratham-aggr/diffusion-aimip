...
class MultilabelCoverageError(Metric):
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.classification import MultilabelCoverageError
        >>> preds = rand(10, 5)
...
class MultilabelRankingAveragePrecision(Metric):
    ...
    Example:
        >>> from torch import rand, randint
        >>> from src.evaluation.torchmetrics.classification import MultilabelRankingAveragePrecision
        >>> preds = rand(10, 5)
        >>> target = randint(2, (10, 5))
...
class MultilabelRankingLoss(Metric):
    ...
    Example:
        >>> from torch import rand, randint
        >>> from src.evaluation.torchmetrics.classification import MultilabelRankingLoss
        >>> preds = rand(10, 5)
        >>> target = randint(2, (10, 5))
