...
from src.evaluation.torchmetrics.utilities.plot import _AX_TYPE, _CMAP_TYPE, _PLOT_OUT_TYPE, plot_confusion_matrix
...
class BinaryConfusionMatrix(Metric):
    ...
    Example (preds is int tensor):
        >>> from src.evaluation.torchmetrics.classification import BinaryConfusionMatrix
    ...
    def plot(
        ...
        .. plot::
            ...
            >>> from src.evaluation.torchmetrics.classification import MulticlassConfusionMatrix
...
class MultilabelConfusionMatrix(Metric):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MultilabelConfusionMatrix
...
class ConfusionMatrix(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinaryConfusionMatrix`,
    :class:`~src.evaluation.torchmetrics.classification.MulticlassConfusionMatrix` and
    :class:`~src.evaluation.torchmetrics.classification.MultilabelConfusionMatrix` for the specific details of each argument influence
    and examples.
