...
class BinaryAUROC(BinaryPrecisionRecallCurve):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import BinaryAUROC
...
class MulticlassAUROC(MulticlassPrecisionRecallCurve):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassAUROC
...
class MultilabelAUROC(MultilabelPrecisionRecallCurve):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MultilabelAUROC
...
class AUROC(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinaryAUROC`, :class:`~src.evaluation.torchmetrics.classification.MulticlassAUROC` and
    :class:`~src.evaluation.torchmetrics.classification.MultilabelAUROC` for the specific details of each argument influence and
    examples.
