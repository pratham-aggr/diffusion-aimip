...
from src.evaluation.torchmetrics.functional.classification.precision_fixed_recall import _precision_at_recall
...
class BinaryPrecisionAtFixedRecall(BinaryPrecisionRecallCurve):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import BinaryPrecisionAtFixedRecall
...
class MulticlassPrecisionAtFixedRecall(MulticlassPrecisionRecallCurve):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassPrecisionAtFixedRecall
...
class MultilabelPrecisionAtFixedRecall(MultilabelPrecisionRecallCurve):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MultilabelPrecisionAtFixedRecall
...
class PrecisionAtFixedRecall(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinaryPrecisionAtFixedRecall`,
    :class:`~src.evaluation.torchmetrics.classification.MulticlassPrecisionAtFixedRecall` and
    :class:`~src.evaluation.torchmetrics.classification.MultilabelPrecisionAtFixedRecall` for the specific details of each argument
