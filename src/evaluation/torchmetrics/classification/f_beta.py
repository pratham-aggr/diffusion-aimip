...
from src.evaluation.torchmetrics.classification.base import _ClassificationTaskWrapper
...
class BinaryFBetaScore(BinaryStatScores):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import BinaryFBetaScore
...
class MulticlassFBetaScore(MulticlassStatScores):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassFBetaScore
...
class MultilabelFBetaScore(MultilabelStatScores):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MultilabelFBetaScore
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
class BinaryF1Score(BinaryFBetaScore):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import BinaryF1Score
        >>> target = tensor([0, 1, 0, 1, 0, 1])
        >>> preds = tensor([0, 0, 1, 1, 0, 1])
...
class MulticlassF1Score(MulticlassFBetaScore):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassF1Score
        >>> target = tensor([2, 1, 0, 0])
        >>> preds = tensor([2, 1, 0, 1])
...
class MultilabelF1Score(MultilabelFBetaScore):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MultilabelF1Score
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
class FBetaScore(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinaryFBetaScore`,
    :class:`~src.evaluation.torchmetrics.classification.MulticlassFBetaScore` and
    :class:`~src.evaluation.torchmetrics.classification.MultilabelFBetaScore` for the specific details of each argument influence
    and examples.
...
class F1Score(_ClassificationTaskWrapper):
    ...
    This function is a simple wrapper to get the task specific versions of this metric, which is done by setting the
    ``task`` argument to either ``'binary'``, ``'multiclass'`` or ``multilabel``. See the documentation of
    :class:`~src.evaluation.torchmetrics.classification.BinaryF1Score`, :class:`~src.evaluation.torchmetrics.classification.MulticlassF1Score` and
    :class:`~src.evaluation.torchmetrics.classification.MultilabelF1Score` for the specific details of each argument influence and
    examples.
