...
from src.evaluation.torchmetrics.functional.classification.hamming import _hamming_distance_reduce
...
class BinaryHammingDistance(BinaryStatScores):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import BinaryHammingDistance
...
class MulticlassHammingDistance(MulticlassStatScores):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassHammingDistance
...
class MultilabelHammingDistance(MultilabelStatScores):
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MultilabelHammingDistance
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
class HammingDistance(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinaryHammingDistance`,
    :class:`~src.evaluation.torchmetrics.classification.MulticlassHammingDistance` and
    :class:`~src.evaluation.torchmetrics.classification.MultilabelHammingDistance` for the specific details of each argument influence
    and examples.
