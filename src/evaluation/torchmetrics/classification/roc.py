...
from src.evaluation.torchmetrics.functional.classification.roc import (
    _binary_roc_compute,
...
class BinaryROC(BinaryPrecisionRecallCurve):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import BinaryROC
...
class MulticlassROC(MulticlassPrecisionRecallCurve):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MulticlassROC
...
class MultilabelROC(MultilabelPrecisionRecallCurve):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import MultilabelROC
...
class ROC(_ClassificationTaskWrapper):
    ...
    :class:`~src.evaluation.torchmetrics.classification.BinaryROC`,
    :class:`~src.evaluation.torchmetrics.classification.MulticlassROC` and
    :class:`~src.evaluation.torchmetrics.classification.MultilabelROC` for the specific details of each argument
