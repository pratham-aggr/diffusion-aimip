...
class FeatureShare(MetricCollection):
    ...
    Example::
        >>> import torch
        >>> from src.evaluation.torchmetrics.wrappers import FeatureShare
        >>> from src.evaluation.torchmetrics.image import FrechetInceptionDistance, KernelInceptionDistance
