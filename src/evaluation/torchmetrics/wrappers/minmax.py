...
class MinMaxMetric(WrapperMetric):
    ...
    Raises:
        ValueError
            If ``base_metric` argument is not a subclasses instance of ``src.evaluation.torchmetrics.Metric``

    Example::
        >>> import torch
        >>> from src.evaluation.torchmetrics.wrappers import MinMaxMetric
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if not isinstance(base_metric, Metric):
            raise ValueError(
                f"Expected base metric to be an instance of `src.evaluation.torchmetrics.Metric` but received {base_metric}"
            )
