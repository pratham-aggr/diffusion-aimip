...
class MultioutputWrapper(WrapperMetric):
    ...
    Several src.evaluation.torchmetrics metrics, such as :class:`~src.evaluation.torchmetrics.regression.spearman.SpearmanCorrCoef` lack support for
    ...
    `MultioutputWrapper` to wrap :class:`src.evaluation.torchmetrics.regression.r2.R2Score` with 2 outputs, one of which occasionally
    ...
    Example:
         ...
         >>> import torch
         >>> from src.evaluation.torchmetrics.wrappers import MultioutputWrapper
         >>> from src.evaluation.torchmetrics.regression import R2Score
