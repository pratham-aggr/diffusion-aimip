...
from src.evaluation.torchmetrics.collections import MetricCollection
...
from src.evaluation.torchmetrics.utilities.plot import _AX_TYPE, _PLOT_OUT_TYPE, plot_single_or_multi_val
...
class MetricTracker(ModuleList):
    ...
    Args:
        metric: instance of a ``src.evaluation.torchmetrics.Metric`` or ``src.evaluation.torchmetrics.MetricCollection``
    ...
    Example (single metric):
        ...
        >>> from src.evaluation.torchmetrics.wrappers import MetricTracker
        >>> from src.evaluation.torchmetrics.classification import MulticlassAccuracy
    ...
    Example (multiple metrics using MetricCollection):
        ...
        >>> from src.evaluation.torchmetrics.wrappers import MetricTracker
        >>> from src.evaluation.torchmetrics import MetricCollection
        >>> from src.evaluation.torchmetrics.regression import MeanSquaredError, ExplainedVariance
    ...
    def __init__(
        ...
        if not isinstance(metric, (Metric, MetricCollection)):
            raise TypeError(
                f"Metric arg need to be an instance of a src.evaluation.torchmetrics `Metric` or `MetricCollection` but got {metric}"
            )
        ...
        if maximize is None:
            ...
            rank_zero_warn(
                "The default value for `maximize` will be changed from `True` to `None` in v1.7.0 of src.evaluation.torchmetrics,"
    ...
    def best_metric(self, return_step: bool = False) -> Union[
        None,
        float,
        Tensor,
    ...
    def plot(
        ...
        .. plot::
            ...
            >>> import torch
            >>> from src.evaluation.torchmetrics.wrappers import MetricTracker
            >>> from src.evaluation.torchmetrics.classification import BinaryAccuracy
