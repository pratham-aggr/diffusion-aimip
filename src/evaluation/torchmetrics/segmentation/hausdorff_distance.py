...
from src.evaluation.torchmetrics.functional.segmentation.hausdorff_distance import (
...
class HausdorffDistance(Metric):
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.segmentation import HausdorffDistance
