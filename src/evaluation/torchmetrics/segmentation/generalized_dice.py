...
from src.evaluation.torchmetrics.functional.segmentation.generalized_dice import (
...
class GeneralizedDiceScore(Metric):
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.segmentation import GeneralizedDiceScore
