...
from src.evaluation.torchmetrics.functional.shape.procrustes import procrustes_disparity
...
class ProcrustesDisparity(Metric):
    ...
    metric: ``src.evaluation.torchmetrics.functional.shape.procrustes.procrustes_disparity``.
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.shape import ProcrustesDisparity
