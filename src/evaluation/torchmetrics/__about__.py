...
__homepage__ = "https://github.com/Lightning-AI/src.evaluation.torchmetrics"
__docs__ = "PyTorch native Metrics"
__docs_url__ = "https://lightning.ai/docs/src.evaluation.torchmetrics/stable/"
__long_doc__ = """
src.evaluation.torchmetrics is a metrics API created for easy metric development and usage in both PyTorch and
