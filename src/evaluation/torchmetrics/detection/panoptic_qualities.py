...
from src.evaluation.torchmetrics.functional.detection._panoptic_quality_common import (
...
class PanopticQuality(Metric):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.detection import PanopticQuality
...
class ModifiedPanopticQuality(Metric):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.detection import ModifiedPanopticQuality
