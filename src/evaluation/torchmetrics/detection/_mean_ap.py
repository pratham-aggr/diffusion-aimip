...
from src.evaluation.torchmetrics.detection.helpers import _fix_empty_tensors, _input_validator
from src.evaluation.torchmetrics.metric import Metric
from src.evaluation.torchmetrics.utilities.data import _cumsum
        ...
        **kwargs: Any,
        ...
        if not _PYCOCOTOOLS_AVAILABLE:
            raise ModuleNotFoundError(
                ...
                " Please install with `pip install pycocotools` or `pip install src.evaluation.torchmetrics[detection]`"
            )
