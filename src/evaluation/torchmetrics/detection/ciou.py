...
from src.evaluation.torchmetrics.functional.detection.ciou import _ciou_compute, _ciou_update
...
class CompleteIntersectionOverUnion(IntersectionOverUnion):
    ...
    Example:
        >>> import torch
        >>> from src.evaluation.torchmetrics.detection import CompleteIntersectionOverUnion
        >>> preds = [
        ...    {
