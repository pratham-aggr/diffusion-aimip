...
from src.evaluation.torchmetrics.functional.detection.diou import _diou_compute, _diou_update
...
class DistanceIntersectionOverUnion(IntersectionOverUnion):
    ...
    Example:
        >>> import torch
        >>> from src.evaluation.torchmetrics.detection import DistanceIntersectionOverUnion
        >>> preds = [
        ...    {
