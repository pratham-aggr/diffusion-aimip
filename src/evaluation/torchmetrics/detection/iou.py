...
from src.evaluation.torchmetrics.functional.detection.iou import _iou_compute, _iou_update
from src.evaluation.torchmetrics.metric import Metric
from src.evaluation.torchmetrics.utilities.data import dim_zero_cat
from src.evaluation.torchmetrics.utilities.imports import _MATPLOTLIB_AVAILABLE, _TORCHVISION_AVAILABLE
...
class IntersectionOverUnion(Metric):
    ...
    Example::
        ...
        >>> import torch
        >>> from src.evaluation.torchmetrics.detection import IntersectionOverUnion
        >>> preds = [
        ...    {
        ...        "boxes": torch.tensor([
