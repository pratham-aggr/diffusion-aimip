...
from src.evaluation.torchmetrics.functional.detection.giou import _giou_compute, _giou_update
...
class GeneralizedIntersectionOverUnion(IntersectionOverUnion):
    ...
    Example:
        >>> import torch
        >>> from src.evaluation.torchmetrics.detection import GeneralizedIntersectionOverUnion
        >>> preds = [
        ...    {
