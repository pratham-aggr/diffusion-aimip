...
from src.evaluation.torchmetrics.functional.clustering.adjusted_mutual_info_score import (
...
class AdjustedMutualInfoScore(MutualInfoScore):
    ...
    Example::
        >>> import torch
        >>> from src.evaluation.torchmetrics.clustering import AdjustedMutualInfoScore
