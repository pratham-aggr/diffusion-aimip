...
from src.evaluation.torchmetrics.functional.clustering.normalized_mutual_info_score import (
...
class NormalizedMutualInfoScore(MutualInfoScore):
    ...
    Example::
        >>> import torch
        >>> from src.evaluation.torchmetrics.clustering import NormalizedMutualInfoScore
