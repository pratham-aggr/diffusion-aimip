...
class HomogeneityScore(Metric):
    ...
    Example:
        >>> import torch
        >>> from src.evaluation.torchmetrics.clustering import HomogeneityScore
...
class CompletenessScore(Metric):
    ...
    Example:
        >>> import torch
        >>> from src.evaluation.torchmetrics.clustering import CompletenessScore
        >>> preds = torch.tensor([2, 1, 0, 1, 0])
        >>> target = torch.tensor([0, 2, 1, 1, 0])
...
class VMeasureScore(Metric):
    ...
    Example::
        >>> import torch
        >>> from src.evaluation.torchmetrics.clustering import VMeasureScore
        >>> preds = torch.tensor([2, 1, 0, 1, 0])
        >>> target = torch.tensor([0, 2, 1, 1, 0])
