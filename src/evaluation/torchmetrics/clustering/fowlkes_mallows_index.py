...
from src.evaluation.torchmetrics.functional.clustering import fowlkes_mallows_index
...
class FowlkesMallowsIndex(Metric):
    ...
    Example::
        >>> import torch
        >>> from src.evaluation.torchmetrics.clustering import FowlkesMallowsIndex
