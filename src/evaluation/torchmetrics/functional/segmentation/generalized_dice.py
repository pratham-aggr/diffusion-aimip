...
from src.evaluation.torchmetrics.functional.segmentation.utils import _ignore_background
...
def generalized_dice_score(
    ...
    Example (with one-hot encoded tensors):
        ...
        >>> from src.evaluation.torchmetrics.functional.segmentation import generalized_dice_score
