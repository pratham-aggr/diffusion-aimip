...
from src.evaluation.torchmetrics.functional.pairwise.helpers import _check_input, _reduce_distance_matrix
...
def pairwise_minkowski_distance(
    ...
    Example:
        >>> import torch
        >>> from src.evaluation.torchmetrics.functional.pairwise import pairwise_minkowski_distance
