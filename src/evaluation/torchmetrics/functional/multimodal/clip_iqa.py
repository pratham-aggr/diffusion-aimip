...
from src.evaluation.torchmetrics.functional.multimodal.clip_score import _get_clip_model_and_processor
from src.evaluation.torchmetrics.utilities.checks import _SKIP_SLOW_DOCTEST, _try_proceed_with_timeout
from src.evaluation.torchmetrics.utilities.imports import _PIQ_GREATER_EQUAL_0_8, _TRANSFORMERS_GREATER_EQUAL_4_10
    ...
    if model_name_or_path == "clip_iqa":
        if not _PIQ_GREATER_EQUAL_0_8:
            raise ValueError(
                ...
                "`pip install src.evaluation.torchmetrics[multimodal]`"
            )
...
def clip_image_quality_assessment(
    ...
    .. hint::
        ...
        `pip install piq` or `pip install src.evaluation.torchmetrics[multimodal]`.
    ...
    Example::
        ...
        >>> from src.evaluation.torchmetrics.functional.multimodal import clip_image_quality_assessment
