...
from src.evaluation.torchmetrics.utilities.imports import _TRANSFORMERS_GREATER_EQUAL_4_10
...
def _get_clip_model_and_processor(
    ...
    raise ModuleNotFoundError(
        ...
        " Either install with `pip install transformers>=4.10.0` or `pip install src.evaluation.torchmetrics[multimodal]`."
    )
...
def clip_score(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.multimodal import clip_score
