...
from src.evaluation.torchmetrics.functional.classification.auroc import binary_auroc
...
def retrieval_auroc(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.retrieval import retrieval_auroc
