...
def _mean_absolute_error_update(preds: Tensor, target: Tensor, flatten: bool) -> tuple[Tensor, int]:
...
def mean_absolute_error(preds: Tensor, target: Tensor, num_outputs: int = 1) -> Tensor:
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.regression import mean_absolute_error
