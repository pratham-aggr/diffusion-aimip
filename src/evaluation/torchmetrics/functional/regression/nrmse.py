...
from src.evaluation.torchmetrics.functional.regression.mse import _mean_squared_error_update
...
def normalized_root_mean_squared_error(
    ...
    Example:
        >>> import torch
        >>> from src.evaluation.torchmetrics.functional.regression import normalized_root_mean_squared_error
