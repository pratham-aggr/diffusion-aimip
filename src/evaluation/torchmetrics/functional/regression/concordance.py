...
from src.evaluation.torchmetrics.functional.regression.pearson import (
...
def concordance_corrcoef(preds: Tensor, target: Tensor) -> Tensor:
    ...
    Example (single output regression):
        >>> from src.evaluation.torchmetrics.functional.regression import concordance_corrcoef
