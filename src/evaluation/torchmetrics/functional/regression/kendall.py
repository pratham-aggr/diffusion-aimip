...
from src.evaluation.torchmetrics.functional.regression.utils import _check_data_shape_to_num_outputs
from src.evaluation.torchmetrics.utilities.checks import _check_same_shape
from src.evaluation.torchmetrics.utilities.data import _bincount, _cumsum, dim_zero_cat
from src.evaluation.torchmetrics.utilities.enums import EnumStr
...
def _get_metric_metadata(preds: Tensor, target: Tensor, variant: _MetricVariant) -> tuple[
    Tensor,
    Tensor,
    Optional[Tensor],
    Optional[Tensor],
...
def kendall_rank_corrcoef(
    ...
    Example (single output regression):
        >>> from src.evaluation.torchmetrics.functional.regression import kendall_rank_corrcoef
