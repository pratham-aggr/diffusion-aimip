...
from src.evaluation.torchmetrics.functional.image.rmse_sw import _rmse_sw_compute, _rmse_sw_update
...
def relative_average_spectral_error(preds: Tensor, target: Tensor, window_size: int = 8) -> Tensor:
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.functional.image import relative_average_spectral_error
