...
from src.evaluation.torchmetrics.functional.image.utils import _gaussian_kernel_2d
...
def universal_image_quality_index(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.image import universal_image_quality_index
        >>> preds = torch.rand([16, 1, 16, 16])
        >>> target = preds * 0.75
