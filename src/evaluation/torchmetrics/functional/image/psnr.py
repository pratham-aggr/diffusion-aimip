...
from src.evaluation.torchmetrics.utilities import rank_zero_warn, reduce
...
def peak_signal_noise_ratio(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.image import peak_signal_noise_ratio
