...
from src.evaluation.torchmetrics.functional.classification.confusion_matrix import _multiclass_confusion_matrix_update
from src.evaluation.torchmetrics.functional.nominal.utils import (
...
def _tschuprows_t_compute(confmat: Tensor, bias_correction: bool) -> Tensor:
    ...
    if bias_correction:
        ...
        tschuprows_t_value = torch.sqrt(
            phi_squared_corrected / torch.sqrt((rows_corrected - 1) * (cols_corrected - 1))
        )
    else:
...
def tschuprows_t(
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.functional.nominal import tschuprows_t
...
def tschuprows_t_matrix(
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.functional.nominal import tschuprows_t_matrix
