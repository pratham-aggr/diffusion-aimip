...
def binary_precision_at_fixed_recall(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import binary_precision_at_fixed_recall
...
def multiclass_precision_at_fixed_recall(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_precision_at_fixed_recall
...
def multilabel_precision_at_fixed_recall(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_precision_at_fixed_recall
...
def precision_at_fixed_recall(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_precision_at_fixed_recall`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_precision_at_fixed_recall` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_precision_at_fixed_recall` for the specific details of
