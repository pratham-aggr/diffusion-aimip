...
def binary_hamming_distance(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import binary_hamming_distance
...
def multiclass_hamming_distance(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_hamming_distance
...
def multilabel_hamming_distance(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_hamming_distance
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
def hamming_distance(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_hamming_distance`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_hamming_distance` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_hamming_distance` for
