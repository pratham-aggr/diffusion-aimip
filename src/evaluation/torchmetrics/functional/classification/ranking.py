...
def multilabel_coverage_error(
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_coverage_error
        >>> preds = rand(10, 5)
...
def multilabel_ranking_average_precision(
    ...
    Example:
        >>> from torch import rand, randint
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_ranking_average_precision
        >>> preds = rand(10, 5)
        >>> target = randint(2, (10, 5))
...
def multilabel_ranking_loss(
    ...
    Example:
        >>> from torch import rand, randint
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_ranking_loss
        >>> preds = rand(10, 5)
        >>> target = randint(2, (10, 5))
