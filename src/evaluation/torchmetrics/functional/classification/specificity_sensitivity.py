...
def binary_specificity_at_sensitivity(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import binary_specificity_at_sensitivity
...
def multiclass_specificity_at_sensitivity(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_specificity_at_sensitivity
...
def multilabel_specificity_at_sensitivity(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_specificity_at_sensitivity
...
def specicity_at_sensitivity(
    ...
    .. warning::
        This function was deprecated in v1.3.0 of src.evaluation.torchmetrics and will be removed in v2.0.0.
...
def specificity_at_sensitivity(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_specificity_at_sensitivity`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_specificity_at_sensitivity` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_specificity_at_sensitivity` for the specific details of
