...
from src.evaluation.torchmetrics.utilities.checks import _check_same_shape, _input_format_classification
from src.evaluation.torchmetrics.utilities.compute import normalize_logits_if_needed
from src.evaluation.torchmetrics.utilities.data import _bincount, select_topk
from src.evaluation.torchmetrics.utilities.enums import AverageMethod, ClassificationTask, DataType, MDMCAverageMethod
...
def binary_stat_scores(
    ...
    Example (preds is int tensor):
        ...
        >>> from src.evaluation.torchmetrics.functional.classification import binary_stat_scores
...
def multiclass_stat_scores(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_stat_scores
...
def multilabel_stat_scores(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_stat_scores
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
def stat_scores(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_stat_scores`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_stat_scores` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_stat_scores` for the specific
