...
from src.evaluation.torchmetrics.utilities.compute import normalize_logits_if_needed
...
def binary_confusion_matrix(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import binary_confusion_matrix
...
def _multiclass_confusion_matrix_tensor_validation(
    ...
    for t, name in (
        ((target, "target"),) + ((preds, "preds"),) if not preds.is_floating_point() else ()
    ):  # noqa: RUF005
...
def multiclass_confusion_matrix(
    ...
    Example (pred is integer tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_confusion_matrix
...
def multilabel_confusion_matrix(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_confusion_matrix
...
def confusion_matrix(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_confusion_matrix`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_confusion_matrix` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_confusion_matrix` for
    the specific details of each argument influence and examples.

    Legacy Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.classification import ConfusionMatrix
        >>> target = tensor([1, 1, 0, 0])
        >>> preds = tensor([0, 1, 0, 0])
