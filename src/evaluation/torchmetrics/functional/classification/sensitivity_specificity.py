...
def binary_sensitivity_at_specificity(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import binary_sensitivity_at_specificity
...
def multiclass_sensitivity_at_specificity(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_sensitivity_at_specificity
...
def multilabel_sensitivity_at_specificity(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_sensitivity_at_specificity
...
def sensitivity_at_specificity(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_sensitivity_at_specificity`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_sensitivity_at_specificity` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_sensitivity_at_specificity` for the specific details of
