...
from src.evaluation.torchmetrics.functional.classification.roc import binary_roc, multiclass_roc, multilabel_roc
...
from src.evaluation.torchmetrics.utilities.data import interp
...
def binary_logauc(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import binary_logauc
        >>> from torch import tensor
...
def multiclass_logauc(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_logauc
...
def multilabel_logauc(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_logauc
