...
def binary_calibration_error(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import binary_calibration_error
...
def multiclass_calibration_error(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_calibration_error
...
def calibration_error(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_calibration_error` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_calibration_error` for the specific details of
