...
from src.evaluation.torchmetrics.utilities.compute import _adjust_weights_safe_divide, _safe_divide
from src.evaluation.torchmetrics.utilities.enums import ClassificationTask
...
def binary_fbeta_score(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import binary_fbeta_score
...
def multiclass_fbeta_score(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_fbeta_score
...
def multilabel_fbeta_score(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_fbeta_score
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
def binary_f1_score(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import binary_f1_score
        >>> target = tensor([0, 1, 0, 1, 0, 1])
        >>> preds = tensor([0, 0, 1, 1, 0, 1])
...
def multiclass_f1_score(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_f1_score
        >>> target = tensor([2, 1, 0, 0])
        >>> preds = tensor([2, 1, 0, 1])
...
def multilabel_f1_score(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_f1_score
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
def fbeta_score(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_fbeta_score`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_fbeta_score` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_fbeta_score` for the specific
...
def f1_score(
    ...
    This function is a simple wrapper to get the task specific versions of this metric, which is done by setting the
    ``task`` argument to either ``'binary'``, ``'multiclass'`` or ``multilabel``. See the documentation of
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_f1_score`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_f1_score` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_f1_score` for the specific
    details of each argument influence and examples.
