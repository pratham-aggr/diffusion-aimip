...
from src.evaluation.torchmetrics.utilities import rank_zero_warn
from src.evaluation.torchmetrics.utilities.compute import _safe_divide, interp
...
def binary_roc(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import binary_roc
...
def multiclass_roc(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_roc
...
def multilabel_roc(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_roc
...
def roc(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_roc`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_roc` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_roc` for the specific details of each argument
