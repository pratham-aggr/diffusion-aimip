...
def binary_negative_predictive_value(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import binary_negative_predictive_value
...
def multiclass_negative_predictive_value(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_negative_predictive_value
...
def multilabel_negative_predictive_value(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_negative_predictive_value
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
def negative_predictive_value(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_negative_predictive_value`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_negative_predictive_value` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_negative_predictive_value` for the specific
