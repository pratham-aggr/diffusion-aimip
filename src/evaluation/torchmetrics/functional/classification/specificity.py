...
def binary_specificity(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import binary_specificity
...
def multiclass_specificity(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_specificity
...
def multilabel_specificity(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_specificity
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
def specificity(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_specificity`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_specificity` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_specificity` for the specific
