...
def binary_precision(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import binary_precision
...
def multiclass_precision(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_precision
...
def multilabel_precision(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_precision
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
def binary_recall(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import binary_recall
        >>> target = tensor([0, 1, 0, 1, 0, 1])
        >>> preds = tensor([0, 0, 1, 1, 0, 1])
...
def multiclass_recall(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_recall
        >>> target = tensor([2, 1, 0, 0])
        >>> preds = tensor([2, 1, 0, 1])
...
def multilabel_recall(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_recall
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
def precision(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_precision`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_precision` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_precision` for the specific details of
...
def recall(
    ...
    This function is a simple wrapper to get the task specific versions of this metric, which is done by setting the
    ``task`` argument to either ``'binary'``, ``'multiclass'`` or ``multilabel``. See the documentation of
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_recall`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_recall` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_recall` for the specific details of
    each argument influence and examples.
