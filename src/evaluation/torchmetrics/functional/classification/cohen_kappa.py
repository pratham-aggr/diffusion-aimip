...
def binary_cohen_kappa(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import binary_cohen_kappa
...
def multiclass_cohen_kappa(
    ...
    Example (pred is integer tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_cohen_kappa
...
def cohen_kappa(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_cohen_kappa` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_cohen_kappa` for the specific details of
