...
from src.evaluation.torchmetrics.utilities.compute import _auc_compute_without_check, _safe_divide
...
def binary_auroc(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import binary_auroc
...
def multiclass_auroc(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_auroc
...
def multilabel_auroc(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_auroc
...
def auroc(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_auroc`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_auroc` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_auroc` for the specific details of
