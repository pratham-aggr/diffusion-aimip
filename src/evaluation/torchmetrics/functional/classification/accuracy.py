...
def binary_accuracy(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import binary_accuracy
...
def multiclass_accuracy(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_accuracy
...
def multilabel_accuracy(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_accuracy
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
def accuracy(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_accuracy`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_accuracy` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_accuracy` for the specific details of
