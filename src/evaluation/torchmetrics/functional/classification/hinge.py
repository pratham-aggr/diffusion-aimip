...
from src.evaluation.torchmetrics.utilities.data import to_onehot
...
def binary_hinge_loss(
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.functional.classification import binary_hinge_loss
...
def multiclass_hinge_loss(
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_hinge_loss
...
def hinge_loss(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_hinge_loss` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_hinge_loss` for the specific details of
