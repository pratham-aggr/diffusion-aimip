...
def binary_recall_at_fixed_precision(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import binary_recall_at_fixed_precision
...
def multiclass_recall_at_fixed_precision(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_recall_at_fixed_precision
...
def multilabel_recall_at_fixed_precision(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_recall_at_fixed_precision
...
def recall_at_fixed_precision(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_recall_at_fixed_precision`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_recall_at_fixed_precision` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_recall_at_fixed_precision` for the specific details of
