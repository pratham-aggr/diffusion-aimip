...
def multiclass_exact_match(
    ...
    Example (multidim tensors):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_exact_match
...
def multilabel_exact_match(
    ...
    Example (preds is int tensor):
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_exact_match
...
def exact_match(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_exact_match` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_exact_match` for the specific details of
