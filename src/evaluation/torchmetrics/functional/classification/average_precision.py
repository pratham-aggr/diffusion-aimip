...
from src.evaluation.torchmetrics.utilities.compute import _safe_divide
from src.evaluation.torchmetrics.utilities.data import _bincount
from src.evaluation.torchmetrics.utilities.enums import ClassificationTask
from src.evaluation.torchmetrics.utilities.prints import rank_zero_warn
...
def binary_average_precision(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import binary_average_precision
...
def _multiclass_average_precision_compute(
    ...
    return _reduce_average_precision(
        ...
        average,
        weights=(
            _bincount(state[1], minlength=num_classes).float() if thresholds is None else state[0][:, 1, :].sum(-1)
        ),
    )
...
def multiclass_average_precision(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multiclass_average_precision
...
def multilabel_average_precision(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.classification import multilabel_average_precision
...
def average_precision(
    ...
    :func:`~src.evaluation.torchmetrics.functional.classification.binary_average_precision`,
    :func:`~src.evaluation.torchmetrics.functional.classification.multiclass_average_precision` and
    :func:`~src.evaluation.torchmetrics.functional.classification.multilabel_average_precision`
    for the specific details of each argument influence and examples.

    Legacy Example:
        >>> from src.evaluation.torchmetrics.functional.classification import average_precision
