...
from src.evaluation.torchmetrics.utilities.imports import _FAST_BSS_EVAL_AVAILABLE
...
def _symmetric_toeplitz(vector: Tensor) -> Tensor:
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.functional.audio.sdr import _symmetric_toeplitz
        >>> v = tensor([0, 1, 2, 3, 4])
...
def signal_distortion_ratio(
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.functional.audio import signal_distortion_ratio
        >>> preds = randn(8000)
        >>> target = randn(8000)
        >>> signal_distortion_ratio(preds, target)
        tensor(-11.9930)
        >>> # use with permutation_invariant_training
        >>> from src.evaluation.torchmetrics.functional.audio import permutation_invariant_training
...
def scale_invariant_signal_distortion_ratio(preds: Tensor, target: Tensor, zero_mean: bool = False) -> Tensor:
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.audio import scale_invariant_signal_distortion_ratio
...
def source_aggregated_signal_distortion_ratio(
    ...
    Example:
        >>> from torch import randn
        >>> from src.evaluation.torchmetrics.functional.audio import source_aggregated_signal_distortion_ratio
