...
from src.evaluation.torchmetrics.functional.audio.sdr import scale_invariant_signal_distortion_ratio
...
def signal_noise_ratio(preds: Tensor, target: Tensor, zero_mean: bool = False) -> Tensor:
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.audio import signal_noise_ratio
...
def scale_invariant_signal_noise_ratio(preds: Tensor, target: Tensor) -> Tensor:
    ...
    Example:
        >>> import torch
        >>> from src.evaluation.torchmetrics.functional.audio import scale_invariant_signal_noise_ratio
        >>> target = torch.tensor([3.0, -0.5, 2.0, 7.0])
        >>> preds = torch.tensor([2.5, 0.0, 2.0, 8.0])
...
def complex_scale_invariant_signal_noise_ratio(preds: Tensor, target: Tensor, zero_mean: bool = False) -> Tensor:
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.functional.audio import complex_scale_invariant_signal_noise_ratio
