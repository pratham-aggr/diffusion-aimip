...
from src.evaluation.torchmetrics.utilities import rank_zero_info, rank_zero_warn
...
SAMPLING_RATE = 16000
INPUT_LENGTH = 9.01
DNSMOS_DIR = "~/.src.evaluation.torchmetrics/DNSMOS"
...
def _prepare_dnsmos(dnsmos_dir: str) -> None:
    ...
    Args:
        dnsmos_dir: a dir to save the downloaded files. Defaults to "~/.src.evaluation.torchmetrics".
    ...
    # save to or load from ~/src.evaluation.torchmetrics/dnsmos/.
...
def deep_noise_suppression_mean_opinion_score(
    ...
    .. hint::
        ...
        as ``pip install src.evaluation.torchmetrics['audio']`` or alternatively ``pip install librosa onnxruntime-gpu requests``
