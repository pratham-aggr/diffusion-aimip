...
from src.evaluation.torchmetrics.utilities.imports import _MULTIPROCESSING_AVAILABLE, _PESQ_AVAILABLE
...
def perceptual_evaluation_speech_quality(
    ...
    .. hint::
        ...
        src.evaluation.torchmetrics[audio]`` or ``pip install pesq``. Note that ``pesq`` will compile with your currently
