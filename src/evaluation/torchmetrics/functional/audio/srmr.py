...
def speech_reverberation_modulation_energy_ratio(
    ...
    .. hint::
        ...
        Either install as ``pip install src.evaluation.torchmetrics[audio]`` or ``pip install torchaudio``
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.functional.audio import speech_reverberation_modulation_energy_ratio
        >>> preds = randn(8000)
    ...
    if not _TORCHAUDIO_AVAILABLE or not _GAMMATONE_AVAILABLE:
        raise ModuleNotFoundError(
            ...
            " `torchaudio>=0.10` installed. Either install as ``pip install src.evaluation.torchmetrics[audio]`` or "
