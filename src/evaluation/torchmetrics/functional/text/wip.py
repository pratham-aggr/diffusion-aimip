...
from src.evaluation.torchmetrics.functional.text.helper import _edit_distance
...
def word_information_preserved(preds: Union[str, list[str]], target: Union[str, list[str]]) -> Tensor:
    ...
    Examples:
        >>> from src.evaluation.torchmetrics.functional.text import word_information_preserved
