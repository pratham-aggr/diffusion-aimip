...
from src.evaluation.torchmetrics.functional.text.helper import _LevenshteinEditDistance as _LE_distance
...
def edit_distance(
    ...
    Example::
        ...
        >>> from src.evaluation.torchmetrics.functional.text import edit_distance
