...
# Reference to the approval: https://github.com/Lightning-AI/src.evaluation.torchmetrics/pull/2701#issuecomment-2316891785
...
from src.evaluation.torchmetrics.functional.text.helper import _validate_inputs
...
def chrf_score(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.text import chrf_score
