...
def calculate_entropy(x: Tensor) -> Tensor:
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.clustering.utils import calculate_entropy
...
def calculate_generalized_mean(x: Tensor, p: Union[int, Literal["min", "geometric", "arithmetic", "max"]]) -> Tensor:
    ...
    Example (p="min"):
        >>> from src.evaluation.torchmetrics.functional.clustering.utils import calculate_generalized_mean
...
def calculate_contingency_matrix(
    ...
    Example:
        >>> import torch
        >>> from src.evaluation.torchmetrics.functional.clustering.utils import calculate_contingency_matrix
...
def calculate_pair_cluster_confusion_matrix(
    ...
    Example:
        >>> import torch
        >>> from src.evaluation.torchmetrics.functional.clustering.utils import calculate_pair_cluster_confusion_matrix
