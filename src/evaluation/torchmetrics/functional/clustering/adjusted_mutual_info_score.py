...
from src.evaluation.torchmetrics.functional.clustering.mutual_info_score import (
...
def adjusted_mutual_info_score(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.clustering import adjusted_mutual_info_score
