...
from src.evaluation.torchmetrics.functional.clustering.utils import check_cluster_labels
from src.evaluation.torchmetrics.utilities.imports import _TORCH_LINEAR_ASSIGNMENT_AVAILABLE
...
def cluster_accuracy(preds: Tensor, target: Tensor, num_classes: int) -> Tensor:
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.clustering import cluster_accuracy
