...
from src.evaluation.torchmetrics.functional.clustering.utils import calculate_entropy, check_cluster_labels
...
def homogeneity_score(preds: Tensor, target: Tensor) -> Tensor:
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.clustering import homogeneity_score
        >>> import torch
...
def completeness_score(preds: Tensor, target: Tensor) -> Tensor:
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.clustering import completeness_score
        >>> import torch
...
def v_measure_score(preds: Tensor, target: Tensor, beta: float = 1.0) -> Tensor:
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.clustering import v_measure_score
        >>> import torch
