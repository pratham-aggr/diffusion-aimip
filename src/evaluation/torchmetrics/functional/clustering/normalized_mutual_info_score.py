...
from src.evaluation.torchmetrics.functional.clustering.utils import (
...
def normalized_mutual_info_score(
    ...
    Example:
        >>> from src.evaluation.torchmetrics.functional.clustering import normalized_mutual_info_score
