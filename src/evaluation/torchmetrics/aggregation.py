...
class MaxMetric(BaseAggregator):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.aggregation import MaxMetric
        >>> metric = MaxMetric()
        >>> metric.update(1)
...
class MinMetric(BaseAggregator):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.aggregation import MinMetric
        >>> metric = MinMetric()
        >>> metric.update(1)
        >>> metric.update(tensor([2, 3]))
        >>> metric.compute()
...
class CatMetric(BaseAggregator):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.aggregation import CatMetric
        >>> metric = CatMetric()
        >>> metric.update(1)
        >>> metric.update(tensor([2, 3]))
        >>> metric.compute()
...
class MeanMetric(BaseAggregator):
    ...
    Example:
        >>> from src.evaluation.torchmetrics.aggregation import MeanMetric
        >>> metric = MeanMetric()
        >>> metric.update(1)
...
class RunningMean(Running):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.aggregation import RunningMean
...
class RunningSum(Running):
    ...
    Example:
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.aggregation import RunningSum
