...
from src.evaluation.torchmetrics.utilities.data import (
    _flatten,
    _squeeze_if_scalar,
    dim_zero_cat,
    dim_zero_max,
...
from src.evaluation.torchmetrics.utilities.distributed import gather_all_tensors
from src.evaluation.torchmetrics.utilities.exceptions import torchmetricsUserError
from src.evaluation.torchmetrics.utilities.imports import _TORCH_GREATER_EQUAL_2_1
...
class Metric(Module, ABC):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        torch._C._log_api_usage_once(f"src.evaluation.torchmetrics.metric.{self.__class__.__name__}")
    ...
    def merge_state(self, incoming_state: Union[dict[str, Any], "Metric"]) -> None:
        ...
        Example with a metric instance:
            ...
            >>> from src.evaluation.torchmetrics.aggregation import SumMetric
            >>> metric1 = SumMetric()
            >>> metric2 = SumMetric()
            >>> metric1.update(1)
            >>> metric2.update(2)
