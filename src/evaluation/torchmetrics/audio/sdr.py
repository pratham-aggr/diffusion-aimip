...
class SignalDistortionRatio(Metric):
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.audio import SignalDistortionRatio
        >>> preds = randn(8000)
        >>> target = randn(8000)
        ...
        tensor(-11.9930)
        >>> # use with pit
        >>> from src.evaluation.torchmetrics.audio import PermutationInvariantTraining
...
class ScaleInvariantSignalDistortionRatio(Metric):
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.audio import ScaleInvariantSignalDistortionRatio
...
class SourceAggregatedSignalDistortionRatio(Metric):
    ...
    Example:
        >>> from torch import randn
        >>> from src.evaluation.torchmetrics.audio import SourceAggregatedSignalDistortionRatio
