...
from src.evaluation.torchmetrics.audio.sdr import ScaleInvariantSignalDistortionRatio, SignalDistortionRatio
from src.evaluation.torchmetrics.audio.snr import ScaleInvariantSignalNoiseRatio, SignalNoiseRatio
...
class _PermutationInvariantTraining(PermutationInvariantTraining):
    ...
    >>> import torch
    >>> from src.evaluation.torchmetrics.functional import scale_invariant_signal_noise_ratio
...
class _SignalDistortionRatio(SignalDistortionRatio):
    ...
    tensor(-11.9930)
    >>> # use with pit
    >>> from src.evaluation.torchmetrics.functional import signal_distortion_ratio
