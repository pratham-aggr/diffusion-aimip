...
class SignalNoiseRatio(Metric):
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.audio import SignalNoiseRatio
...
class ScaleInvariantSignalNoiseRatio(Metric):
    ...
    Example:
        >>> import torch
        >>> from torch import tensor
        >>> from src.evaluation.torchmetrics.audio import ScaleInvariantSignalNoiseRatio
        >>> target = tensor([3.0, -0.5, 2.0, 7.0])
        >>> preds = tensor([2.5, 0.0, 2.0, 8.0])
...
class ComplexScaleInvariantSignalNoiseRatio(Metric):
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.audio import ComplexScaleInvariantSignalNoiseRatio
