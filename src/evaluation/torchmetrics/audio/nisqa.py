...
class NonIntrusiveSpeechQualityAssessment(Metric):
    ...
    .. caution::
        ...
        :func:`~src.evaluation.torchmetrics.functional.audio.nisqa.non_intrusive_speech_quality_assessment`.
    ...
    Example:
        >>> import torch
        >>> from src.evaluation.torchmetrics.audio import NonIntrusiveSpeechQualityAssessment
