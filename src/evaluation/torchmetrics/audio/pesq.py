...
from src.evaluation.torchmetrics.utilities.imports import _MATPLOTLIB_AVAILABLE, _PESQ_AVAILABLE
...
class PerceptualEvaluationSpeechQuality(Metric):
    ...
    .. hint::
        ...
        src.evaluation.torchmetrics[audio]`` or ``pip install pesq``. ``pesq`` will compile with your currently
    ...
    .. caution::
        ...
        :func:`~src.evaluation.torchmetrics.functional.audio.pesq.perceptual_evaluation_speech_quality`.
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.audio import PerceptualEvaluationSpeechQuality
        >>> preds = randn(8000)
        >>> target = randn(8000)
        ...
        **kwargs: Any,
        ...
        if not _PESQ_AVAILABLE:
            raise ModuleNotFoundError(
                ...
                " Either install as `pip install src.evaluation.torchmetrics[audio]` or `pip install pesq`."
            )
