...
class DeepNoiseSuppressionMeanOpinionScore(Metric):
    ...
    .. hint::
        ...
        Install as ``pip install src.evaluation.torchmetrics['audio']`` or alternatively `pip install librosa onnxruntime-gpu requests`
    ...
    .. caution::
        ...
        :func:`~src.evaluation.torchmetrics.functional.audio.dnsmos.deep_noise_suppression_mean_opinion_score`.
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.audio import DeepNoiseSuppressionMeanOpinionScore
        >>> preds = randn(8000)
