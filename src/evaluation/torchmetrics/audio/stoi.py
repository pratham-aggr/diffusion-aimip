...
from src.evaluation.torchmetrics.utilities.imports import _MATPLOTLIB_AVAILABLE, _PYSTOI_AVAILABLE
...
class ShortTimeObjectiveIntelligibility(Metric):
    ...
    .. hint::
        ...
        src.evaluation.torchmetrics[audio]`` or ``pip install pystoi``.
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.audio import ShortTimeObjectiveIntelligibility
        >>> preds = randn(8000)
        >>> target = randn(8000)
        ...
        **kwargs: Any,
        ...
        if not _PYSTOI_AVAILABLE:
            raise ModuleNotFoundError(
                ...
                " Either install as `pip install src.evaluation.torchmetrics[audio]` or `pip install pystoi`."
            )
        self.fs = fs
