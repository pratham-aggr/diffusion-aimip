...
from src.evaluation.torchmetrics.functional.nominal.cramers import _cramers_v_compute, _cramers_v_update
...
class CramersV(Metric):
    ...
    Example::
        ...
        >>> from src.evaluation.torchmetrics.nominal import CramersV
