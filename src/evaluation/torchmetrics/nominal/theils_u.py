...
from src.evaluation.torchmetrics.functional.nominal.theils_u import _theils_u_compute, _theils_u_update
...
class TheilsU(Metric):
    ...
    Example::
        ...
        >>> from src.evaluation.torchmetrics.nominal import TheilsU
        >>> preds = randint(10, (10,))
