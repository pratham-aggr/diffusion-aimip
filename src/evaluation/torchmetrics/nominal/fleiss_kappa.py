...
from src.evaluation.torchmetrics.functional.nominal.fleiss_kappa import _fleiss_kappa_compute, _fleiss_kappa_update
...
class FleissKappa(Metric):
    ...
    Example:
        ...
        >>> from src.evaluation.torchmetrics.nominal import FleissKappa
