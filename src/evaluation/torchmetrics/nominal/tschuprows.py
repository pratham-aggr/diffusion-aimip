...
from src.evaluation.torchmetrics.functional.nominal.tschuprows import _tschuprows_t_compute, _tschuprows_t_update
from src.evaluation.torchmetrics.functional.nominal.utils import _nominal_input_validation
...
class TschuprowsT(Metric):
    ...
    Example::
        ...
        >>> from src.evaluation.torchmetrics.nominal import TschuprowsT
