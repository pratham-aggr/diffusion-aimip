...
from src.ace_inference.core.scheduler import SchedulerConfig
...
class Optimization:
    ...
    def get_state(self):
        ...
        state = {
            ...
            "gscaler_state_dict": self.gscaler.state_dict() if self.gscaler is not None else None,
        }
        return state
...
class DisabledOptimizationConfig:
    ...
    scheduler: SchedulerConfig = dataclasses.field(default_factory=lambda: SchedulerConfig())
