...
class VideoDataWriter:
    ...
    def __init__(
        ...
        """
        self.path = path
        self._metrics_filename = str(Path(path) / "reduced_autoregressive_predictions.nc")
        self.metadata = metadata
        self.coords = coords
        self._video = VideoAggregator(n_timesteps=n_timesteps, enable_extended_videos=True)
