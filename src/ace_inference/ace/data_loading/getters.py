...
def _subset_dataset(dataset: Dataset, subset: slice) -> Dataset:
    ...
    subsetted_dataset.loss_weights_tensor = dataset.loss_weights_tensor
...
def _get_ensemble_dataset(
    ...
    **kwargs,
    ...
    ensemble.loss_weights_tensor = datasets[0].loss_weights_tensor  # type: ignore
...
def get_dataset(
    params: DataLoaderConfig, requirements: DataRequirements, dataset_class: Optional[Dataset] = None, **kwargs
) -> Dataset:
    dataset_class = dataset_class or XarrayDataset
